...
let itemIsNotSelected:boolean = true; //for rendering items

function levelGeneration(indexCellX:number, indexCellY:number):void {
  //get all positions--------------------------------------------------
...
function initPositions(indexCellX:number, indexCellY:number):void {
  ...
  switch(mapObjects.typeMap) {
    case 'Tsaritsyno Park':
      ...
      maps[mapObjects.typeMap].forEach((row:string[], indexRow:number):void => {
        row.forEach((cell: string, indexCell: number): void => {
          if (cell.match(/\//)) {
            mapObjects.edge.push(new Edge(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1));
          }

          if (cell.match(/end/)) {
            mapObjects.endLevel = new EndLevel(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1);
          }
          ...
          if (cell.match(/\s/)) {
            mapObjects.water.push(new Water(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1, './images/water/water-sprite.png'));
          }

          if (cell.match(/_\d+/)) {
            mapObjects.floor.push(new Floor(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1,
              './images/floor/lawn.png', cell.substr(cell.indexOf('_') + 1, 2)));
          }

          if (cell.match(/d\d+/)) {
            mapObjects.decor.push(new Decor(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1,
              './images/floor/decor.png', cell.substr(cell.indexOf('d') + 1, 2)));
          }

          if (cell.match(/t/)) {
            mapObjects.tree.push(new Tree(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell / 3 + 1, field.sizeCell,
              './images/tree/tree-sprite.png'));
          }

          if (cell.match(/h\d+/)) {
            mapObjects.tablet.push(new Tablet(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell * 3/4, objHints[parseInt(cell.substr(cell.indexOf('h') + 1, 2))],
              './images/tablet/tablet.png',
              './images/tablet/tablet-hint.png'));
          }

          if (cell.match(/i\d+/)) {
            player.playerTasks.backpack.forEach((item:string):void => {
              if (item === `i${String(parseInt(`${cell[cell.indexOf('i') + 1]}${cell[cell.indexOf('i') + 2]}`))}`) {
                itemIsNotSelected = false;
              }
            });

            if (itemIsNotSelected) {
              mapObjects.item.push(new Item(
                indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
                indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
                field.sizeCell / 4, cell.substr(cell.indexOf('i') + 1, 2)));
            } else itemIsNotSelected = true;
          }

          if (cell.match(/n[A-Z]+/)) {
            switch(cell[cell.indexOf('n') + 1]) {
              case 'B':
                mapObjects.npc.interlocutor.push(new Interlocutor(
                  indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w) + field.sizeCell * 2/3,
                  indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h) - field.sizeCell / 3,
                  field.sizeCell / 3, field.sizeCell / 2 * 1.3,
                  'Borya', player.stageOfConversation.Borya, objAudio.NPC['Borya'], './images/characters/borya.png', 364));
                break;

              case 'D':
                mapObjects.npc.interlocutor.push(new Interlocutor(
                  indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w) + field.sizeCell / 3,
                  indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h) + field.sizeCell / 3,
                  field.sizeCell / 3, field.sizeCell / 2 * 1.1,
                  'Danya', player.stageOfConversation.Danya, objAudio.NPC['Danya'],
                  './images/characters/danya.png', 308));
                break;
              ...
              case 'M':
                mapObjects.npc.interlocutor.push(new Interlocutor(
                  ...
                  indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h) + field.sizeCell / 3,
                  field.sizeCell / 3, field.sizeCell / 2 * 1.1,
                  'Mark', player.stageOfConversation.Mark, objAudio.NPC['Mark'],
                  './images/characters/mark.png', 308));
                break;
              ...
              case 'A':
                mapObjects.npc.interlocutor.push(new Interlocutor(
                  indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w) + field.sizeCell * 2/3,
                  indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h) + field.sizeCell / 3,
                  field.sizeCell / 3, field.sizeCell / 2 * .9,
                  'Alina', player.stageOfConversation.Alina, objAudio.NPC['Alina'],
              ...
              case 'K':
                mapObjects.npc.interlocutor.push(new Interlocutor(
                  ...
                  indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h) + field.sizeCell / 3,
                  field.sizeCell / 3, field.sizeCell / 2 * 1.1,
                  'Kolya', player.stageOfConversation.Kolya, objAudio.NPC['Kolya'],
                  './images/characters/kolya.png', 308));
                break;
            }
          }
        });
    ...
    case 'Night Parish':
      ...
      if (mapObjects.UniversityInFlesh.length === 0) {
        mapObjects.UniversityInFlesh.push(new UniversityInFlesh(
          canvas.width - field.sizeCell * 3,
          field.sizeCell,
          field.sizeCell * 1.5,
          field.sizeCell * 2
        ));
        ...
        row.forEach((cell:string, indexCell:number):void => {
          if (cell.match(/_\d+/)) {
            mapObjects.floor.push(new Floor(
              ...
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell,
              './images/floor/wooden-floor.png', cell.substr(cell.indexOf('_') + 1, 2)));
          }
        });
      });
      break;
        ...
        row.forEach((cell:string, indexCell:number):void => {
          ...
          if (cell.match(/_\d+/)) {
            mapObjects.floor.push(new Floor(
              ...
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell,
              './images/floor/stone-floor.png', cell.substr(cell.indexOf('_') + 1, 2)));
          }
          ...
          if (cell.match(/d\d+/)) {
            mapObjects.decor.push(new Decor(
              ...
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1,
              './images/floor/dungeon-decor.png', cell.substr(cell.indexOf('d') + 1, 2)));
          }

          if (cell.match(/\|\d+/)) {
            mapObjects.wall.push(new Wall(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - field.sizeCell / 2 - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell,
              cell.substr(cell.indexOf('|') + 1, 2)));
          }
          ...
          if (cell.match(/h\d+/)) {
            mapObjects.tablet.push(new Tablet(
              ...
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell * 3/4, objHints[parseInt(cell.substr(cell.indexOf('h') + 1, 2))],
              './images/tablet/dungeon-tablet.png',
              './images/tablet/dungeon-tablet-hint.png'));
          }
            ...
            switch(cell[cell.indexOf('n') + 1]) {
              case 'V':
                mapObjects.npc.interlocutor.push(new Interlocutor(
                  indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w) + field.sizeCell * 2/3,
                  indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h) - field.sizeCell / 3,
                  field.sizeCell / 3, field.sizeCell / 2 * 1.2,
                  'Vlad', player.stageOfConversation.Vlad, objAudio.NPC['Vlad'],
                  './images/characters/vlad.png', 336));
                break;
              ...
              case 'D':
                mapObjects.npc.interlocutor.push(new Interlocutor(
                  indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w) + field.sizeCell / 3,
                  indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h) + field.sizeCell / 3,
                  field.sizeCell/3, field.sizeCell / 2,
                  'Drunk', player.stageOfConversation.Drunk, objAudio.NPC['Drunk'],
                  './images/characters/drunk.png', 280));
                break;

              case 'W':
                mapObjects.npc.wounded.push(new Wounded(
                  indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w) + field.sizeCell / 3,
                  indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h) + field.sizeCell / 3,
                  field.sizeCell / 3, field.sizeCell / 2 * .8,
                  'Wounded', objAudio.NPC['Wounded'], 196, 224,
                  player.playerTasks.completedDialogues.Wounded, player.stageOfConversation.Wounded));
                break;
            }
          }

          if (cell.match(/p\d+/)) {
            mapObjects.people.push(new People(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell, cell.substr(cell.indexOf('p') + 1, 2)));
          }
        });
      });
      break;
        ...
        row.forEach((cell: string, indexCell: number): void => {
          ...
          if (cell.match(/\s/)) {
            mapObjects.water.push(new Water(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1, './images/water/dead-water-sprite.png'));
          }
          ...
          if (cell.match(/_\d+/)) {
            mapObjects.floor.push(new Floor(
              ...
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1,
              './images/floor/dead-lawn.png', cell.substr(cell.indexOf('_') + 1, 2)));
          }
          ...
          if (cell.match(/d\d+/)) {
            mapObjects.decor.push(new Decor(
              ...
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1,
              './images/floor/dead-decor.png', cell.substr(cell.indexOf('d') + 1, 2)));
          }
          ...
          if (cell.match(/[^et]t([^a]|$)/)) {
            mapObjects.tree.push(new Tree(
              ...
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell / 3 + 1, field.sizeCell,
              './images/tree/dead-tree-sprite.png'));
          }
          ...
          if (cell.match(/h\d+/)) {
            mapObjects.tablet.push(new Tablet(
              ...
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell * 3/4, objHints[parseInt(cell.substr(cell.indexOf('h') + 1, 2))],
              './images/tablet/dead-tablet.png',
              './images/tablet/dead-tablet-hint.png'));
          }
          ...
          if (cell.match(/target/)) {
            mapObjects.target.push(new Target(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1));
          }
    ...
    case 'Lawn Of Lera':
      ...
      maps[mapObjects.typeMap].forEach((row:string[], indexRow:number):void => {
        row.forEach((cell: string, indexCell: number): void => {
          ...
          if (cell.match(/f\d+/g)) {
            cell.match(/f\d+/g).forEach((fence:string):void => {
              mapObjects.fence.push(new Fence(
                indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
                indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
                field.sizeCell, './images/fence/fence.png', {x: +fence[fence.indexOf('f') + 1], y: +fence[fence.indexOf('f') + 2]}
              ));
            });
          }
          ...
          if (cell.match(/n[A-Z]+/)) {
            switch(cell[cell.indexOf('n') + 1]) {
              case 'L':
                mapObjects.npc.lera.push(new Lera(
                  indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w) + field.sizeCell * 2/3,
                  indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h) - field.sizeCell / 3,
                  field.sizeCell / 3 * .9, field.sizeCell / 2,
                  'Lera', player.stageOfConversation.Lera, objAudio.NPC['Lera'],
                  176, 280));
            }
          }
        });
      ...
      maps[mapObjects.typeMap].forEach((row:string[], indexRow:number):void => {
        row.forEach((cell: string, indexCell: number): void => {
          ...
          if (cell.match(/stage\d/) && level.levelStage !== +cell[cell.indexOf('stage') + 5]) {
            mapObjects.stage.push(new ChangeStageOfLevel(
              indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
              indexRow * field.sizeCell - (camera.currentPosition.startY - halfCanvas.h),
              field.sizeCell + 1, +cell[cell.indexOf('stage') + 5]));
          }

          if (cell.match(/\|\d?/)) {
            if (level.levelStage === 3) {
              mapObjects.cubicZirconia.push(new CubicZirconia(
                indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
                indexRow * field.sizeCell - field.sizeCell / 2 - (camera.currentPosition.startY - halfCanvas.h),
                field.sizeCell, 'neutral'));
            } else {
              if (cell[cell.indexOf('|') + 1] === '0') {
                mapObjects.cubicZirconia.push(new CubicZirconia(
                  indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
                  indexRow * field.sizeCell - field.sizeCell / 2 - (camera.currentPosition.startY - halfCanvas.h),
                  field.sizeCell, 'absent'));
              } else {
                mapObjects.cubicZirconia.push(new CubicZirconia(
                  indexCell * field.sizeCell - (camera.currentPosition.startX - halfCanvas.w),
                  indexRow * field.sizeCell - field.sizeCell / 2 - (camera.currentPosition.startY - halfCanvas.h),
...
function adaptGameField():void {
  resizeCanvas();

  if (mapObjects.typeMap !== 'Introduction') {
    if (
      canvas.height === previousCanvas.h &&
      ...
      if (mapObjects.typeMap !== 'Night Parish') {
        if (player.x <= mapObjects.edge[0].x) player.x = mapObjects.edge[0].x;

        if (player.x + player.width >= mapObjects.edge[1].x + mapObjects.edge[1].size) player.x = mapObjects.edge[1].x + mapObjects.edge[1].size - player.width;
      }
...
function adaptingPositions(ratio:number):void {
...
function renderingCountItems():void {
  ctx.fillStyle = '#A32653';
  ctx.font = `900 ${field.sizeCell / 10}px Pixel Art`;
  ctx.textBaseline = 'alphabetic';
  ctx.textAlign = 'start';
  ctx.fillText(`Осталось на локации: ${mapObjects.item.length}`, field.sizeCell * .75, field.sizeCell / 3);
}

function renderingNumberOfLives():void {
...
function renderingNumberOfLivesBoss(typeBoss:'University'|'Blick'):void {
  switch(typeBoss) {
    case 'University':
      ctx.fillStyle = 'white';
