...
import {backpackButton, camera, canvas, ctx, halfCanvas, keys, level, mapObjects} from "../variables/variables.js";
...
import {Interlocutor} from "../classes/npc.js";
...
export function renderingFirstLevel():void {
  ...
  if (Math.random() * 10000 <= 2 && !player.thinks) player.audio.laLaLa.play();
